  ...
  return (
    <>
      <button
        ...
        className="px-5 py-2.5 bg-[#003865] text-white rounded border border-[#003865] hover:bg-[#002D4F] transition-colors font-semibold flex items-center gap-2 shadow-sm text-sm whitespace-nowrap"
      >
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded border border-gray-200 shadow-lg max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            {/* Header */}
            <div className="bg-[#003865] px-6 py-4 text-white border-b-4 border-[#DC143C]">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div className="min-w-0 flex-1">
                    <h2 className="text-lg font-bold whitespace-nowrap">Share Success Story</h2>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded p-5 mb-6">
                <div className="text-center mb-5">
                  ...
                  <h3 className="text-lg font-bold text-[#003865] mb-1">
                    Issue Resolved
                  </h3>
                  <p className="text-sm text-gray-700 capitalize">
                    {issue.category}
                  </p>
                  <p className="text-xs text-gray-600 flex items-center justify-center gap-1.5 mt-1">
                ...
                {beforeAfter && beforeAfter.length > 0 && (
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div className="bg-white rounded border border-gray-200 p-3">
                      <p className="text-xs font-semibold text-gray-700 mb-2 text-center uppercase tracking-wide">
                        Initial Condition
                      </p>
                      <img
                ...
                <div className="bg-white rounded border border-green-300 p-3 text-center">
            ...
            <div className="border-t border-gray-200 px-6 py-3 bg-gray-50">
              <div className="flex justify-end">
                <button
                  onClick={() => setShowShareModal(false)}
                  className="px-5 py-2 bg-gray-600 text-white rounded border border-gray-600 hover:bg-gray-700 transition-colors font-semibold text-sm"
                >
                  Close
                </button>
              </div>
