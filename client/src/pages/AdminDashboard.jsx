          ...
          <div className="bg-white border-l-4 border-[#DC143C] shadow-md p-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Your current role: <strong className="text-[#DC143C]">{user.role || "user"}</strong>
              </p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center bg-white border border-gray-200 p-12">
          ...
          <p className="mt-6 text-gray-700 text-base font-semibold">Loading issues...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border-l-4 border-[#003865] shadow-md mb-8 p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-[#003865] mb-1">Admin Panel</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-8">
          <div className="bg-[#003865] text-white p-5 border border-[#003865] shadow-sm">
            <p className="text-xs opacity-90 uppercase tracking-wide font-medium">Total Issues</p>
          ...
          <div className="bg-yellow-600 text-white p-5 border border-yellow-600 shadow-sm">
            <p className="text-xs opacity-90 uppercase tracking-wide font-medium">Pending</p>
          ...
          <div className="bg-blue-600 text-white p-5 border border-blue-600 shadow-sm">
            <p className="text-xs opacity-90 uppercase tracking-wide font-medium">In Progress</p>
          ...
          <div className="bg-green-600 text-white p-5 border border-green-600 shadow-sm">
            <p className="text-xs opacity-90 uppercase tracking-wide font-medium">Resolved</p>
            ...
            >
              ...
              {categories.map((category) => (
                <option key={category} value={category}>
                  {category} ({categoryCounts[category] || 0}) - {getDepartmentForCategory(category)}
                </option>
              ))}
            </select>
            <ChevronDown className="w-4 h-4 text-gray-400 absolute right-3 top-9 pointer-events-none" />
        ...
        {(filterStatus !== "all" || filterCategory !== "all" || filterWard !== "all") && (
          <div className="mt-4 pt-4 border-t border-gray-200">
            ...
            <p className="text-xs text-gray-600 mt-3 font-medium">
              Showing <strong className="text-[#003865]">{filteredIssues?.length || 0}</strong> of <strong>{issues?.length || 0}</strong> issues
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-white border border-gray-200 shadow-sm rounded overflow-hidden mb-6">
                ...
                <div className="hidden md:grid grid-cols-12 gap-4 items-center">
                      ...
                      <div className="min-w-0 flex-1">
                        {issue.isAnonymous ? (
                          <div className="flex flex-col gap-0.5">
                            <span className="text-xs text-gray-500 italic truncate">Anonymous</span>
                          ...
                          <span className="text-xs text-gray-700 truncate">
                            {issue.user?.fullName || issue.user?.email || "Unknown"}
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="col-span-2 flex items-center justify-end gap-3 text-xs text-gray-600">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold">{issue.upvoteCount || 0}</span>
                    </div>
                    <div className="flex items-center gap-1">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        ...
                        >
                          {getStatusIcon(issue.status)}
                          <span className="capitalize hidden sm:inline">{issue.status}</span>
                        </span>
                      </div>
                      {issue.category && (
                        <p className="text-xs text-gray-500 mb-1 truncate">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span className="truncate">
                            {issue.isAnonymous ? "Anonymous" : (issue.user?.fullName || "Unknown")}
                          </span>
                        </div>
                        <div className="flex items-center gap-1">
                          <svg className="w-3 h-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-[#003865]">Reviews & Feedback</h2>
            <Link
              to="/admin/reviews"
