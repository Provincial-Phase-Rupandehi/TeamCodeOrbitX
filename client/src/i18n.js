...
const enTranslationsData = {
  ...
  navbar: {
    title: "Sanket",
    welcome: "Sanket Public Issue Reporting Portal",
  },
  hero: {
  ...
  reportIssue: {
    ...
    aiError:
      "Failed to generate AI description. Please try again or write manually.",
    ...
    anonymousNote:
      "Your name will be hidden from public view, but admins can still see who posted this issue.",
  ...
  advancedReporting: {
    hero: {
      ...
      subtitle:
        "Powerful tools and analytics to track, analyze, and manage community issues effectively",
    },
    features: {
      title: "Key Features",
    },
  ...
  makeDifference: {
    ...
    ways: {
      ...
      report: {
        title: "Report Issues",
        description:
          "Report problems you see in your community - roads, waste, electricity, water, and more",
        action: "Report Now",
      },
      support: {
        title: "Support Issues",
        description:
          "Upvote and comment on issues that matter to you and your community",
        action: "View Feed",
      },
      share: {
        title: "Share Success Stories",
        description:
          "Share before/after photos and success stories on social media to inspire others",
        action: "View Leaderboard",
      },
      community: {
        title: "Engage with Community",
        description:
          "Track issues on the heatmap and see how your community is improving",
        action: "View Heatmap",
      },
    },
    stories: {
      ...
      story1: {
        ...
        description:
          "50+ waste spots cleared in last month through coordinated reporting",
      ...
      story3: {
        ...
        description:
          "Water supply issues resolved in 8 locations, benefiting thousands",
    ...
    cta: {
      ...
      description:
        "Every report matters. Together we can build a better Rupandehi.",
      button1: "Join Now",
      button2: "Report an Issue",
    },
  },
  footer: {
    aboutTitle: "About Sanket",
    aboutDescription:
      "A citizen-driven platform for reporting and tracking community issues in Rupandehi District.",
...
const npTranslationsData = {
  ...
  reportIssue: {
    ...
    aiError:
      "AI विवरण उत्पादन गर्न असफल भयो। कृपया पुनः प्रयास गर्नुहोस् वा म्यानुअल रूपमा लेख्नुहोस्।",
    ...
    anonymousNote:
      "तपाईंको नाम सार्वजनिक दृश्यबाट लुकाइनेछ, तर प्रशासकहरूले अझै पनि देख्न सक्छन् कि कसले यो समस्या पोस्ट गरेको छ।",
  ...
  issueDetails: {
    ...
    reviewNote:
      "समस्या कति राम्रोसँग समाधान भयो भनी मूल्याङ्कन गरेर हामीलाई सुधार गर्न मद्दत गर्नुहोस्।",
    rating: "मूल्याङ्कन *",
    comment: "टिप्पणी (वैकल्पिक)",
    shareThoughts:
      "समस्या कसरी समाधान भयो भन्ने बारेमा आफ्नो विचार साझा गर्नुहोस्...",
  ...
  admin: {
    ...
    manageIssues:
      "प्रयोगकर्ताहरूले रिपोर्ट गरेका सबै समस्याहरू व्यवस्थापन र ट्र्याक गर्नुहोस्",
    ...
    beforeImageNote:
      'यो रिपोर्टरले पेश गरेको मूल तस्बिर हो। यो स्वचालित रूपमा "पहिले" तस्बिरको रूपमा प्रयोग गरिनेछ।',
    ...
    anonymousNote:
      "यो पोस्ट जनताको लागि गुमनाम छ, तर तपाईं प्रशासकको रूपमा रिपोर्टरको विवरण देख्न सक्नुहुन्छ।",
  },
  leaderboard: {
  ...
  profile: {
    ...
    shareNote:
      "समुदायमा तपाईंको योगदानको बारेमा आफ्ना साथीहरूलाई जानकारी दिनुहोस्!",
  },
  notifications: {
    title: "सूचनाहरू",
  ...
  advancedReporting: {
    hero: {
      ...
      subtitle:
        "समुदायका समस्याहरू प्रभावकारी रूपमा ट्र्याक, विश्लेषण र व्यवस्थापन गर्न शक्तिशाली उपकरणहरू र विश्लेषण",
    },
    features: {
    ...
    reports: {
      ...
      description:
        "विश्लेषण र कागजातका लागि विस्तृत रिपोर्टहरू उत्पादन गर्नुहोस्",
    },
    export: {
      title: "डाटा निर्यात",
    ...
    benefits: {
      ...
      efficiency: {
        ...
        description:
          "कार्यप्रवाहहरू सुव्यवस्थित गर्नुहोस् र म्यानुअल प्रक्रियाहरू कम गर्नुहोस्",
      },
      insights: {
      ...
      security: {
        ...
        description:
          "भूमिका-आधारित पहुँच नियन्त्रणसहित सुरक्षित डाटा ह्यान्डलिङ",
      },
    },
    cta: {
  ...
  makeDifference: {
    hero: {
      ...
      subtitle:
        "रुपन्देही जिल्लालाई सुधार गर्न सँगै काम गर्ने हजारौं नागरिकहरूमा सामेल हुनुहोस्",
    ...
    ways: {
      ...
      report: {
        ...
        description:
          "तपाईंले आफ्नो समुदायमा देख्नुभएका समस्याहरू रिपोर्ट गर्नुहोस् - सडक, फोहोर, बिजुली, पानी र थप",
        action: "अहिले रिपोर्ट गर्नुहोस्",
      },
      support: {
        title: "समस्याहरू समर्थन गर्नुहोस्",
        description:
          "तपाईं र तपाईंको समुदायका लागि महत्त्वपूर्ण समस्याहरूमा अपभोट र टिप्पणी गर्नुहोस्",
        action: "फिड हेर्नुहोस्",
      },
      share: {
        title: "सफलताका कथाहरू साझा गर्नुहोस्",
        description:
          "अरूलाई प्रेरणा दिन सामाजिक सञ्जालमा पहिले/पछिका तस्बिरहरू र सफलताका कथाहरू साझा गर्नुहोस्",
        action: "लीडरबोर्ड हेर्नुहोस्",
      },
      community: {
        title: "समुदायसँग जोडिनुहोस्",
        description:
          "हिटम्यापमा समस्याहरू ट्र्याक गर्नुहोस् र तपाईंको समुदाय कसरी सुधार हुँदैछ हेर्नुहोस्",
    ...
    stories: {
      ...
      story1: {
        ...
        description:
          "समन्वित रिपोर्टिङ मार्फत अघिल्लो महिनामा ५०+ फोहोर स्थानहरू सफा गरियो",
      ...
      story3: {
        ...
        description:
          "८ स्थानहरूमा पानी आपूर्ति समस्याहरू समाधान भयो, हजारौंलाई लाभान्वित",
    ...
    cta: {
      ...
      description:
        "हरेक रिपोर्ट महत्त्वपूर्ण छ। सँगै हामी राम्रो रुपन्देही निर्माण गर्न सक्छौं।",
  ...
  footer: {
    ...
    aboutDescription:
      "रुपन्देही जिल्लामा समुदायका समस्याहरू रिपोर्ट र ट्र्याक गर्न नागरिक-संचालित प्लेटफर्म।",
